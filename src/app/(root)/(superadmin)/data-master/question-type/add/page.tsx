...
import { postSubmitTypeQuestion, } from "@/services/api";
...
const AddQuestionType = () => {
    ...
    // 
    const { handlePostSubmit } = postSubmitTypeQuestion();
    ...
    return (
        <div className="">
            <TitleBack href="/data-master/package-type" title="Tambah Tipe Pertanyaan" />
            {/* form */}

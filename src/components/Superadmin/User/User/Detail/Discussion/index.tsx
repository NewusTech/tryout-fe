            ...
            <main className="py-4 flex flex-col">
                ...
                <aside className="mb-14">
                    <div className="flex mb-8 justify-between items-center">
                        <div className="mb-4 flex gap-3 text-sm md:text-base">
                        ...
                        <div className="flex text-sm md:text-base gap-3">
                            <div className="flex w-[90px] flex-col gap-1 bg-succes rounded-md shadow p-1 items-center text-white">
                                <div className="">1</div>
                                <div className="">Benar</div>
                            </div>
                            <div className="flex flex-col w-[90px] gap-1 bg-error rounded-md shadow p-1 items-center text-white">
                                <div className="">1</div>
                                <div className="">Benar</div>
                            </div>
                            <div className="flex flex-col w-[90px] gap-1 bg-white border border-gray-100 text-black rounded-md shadow p-1 items-center">
                                <div className="">1</div>
                                <div className="">Benar</div>
                            </div>
                        </div>
                ...
                <div className="flex flex-col md:gap-4 gap-3">
                    <h1 className="text-primary text-xl font-medium">Tes Wawasan Kebangsaan - TWK </h1>

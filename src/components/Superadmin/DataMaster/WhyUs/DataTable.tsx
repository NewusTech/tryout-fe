...
import { WhyUsResponse } from "@/types/interface";
...
const DataTable: React.FC<WhyUsResponse> = ({ headers, data, currentPage, search, }) => {
                        ...
                        {data?.length > 0 ? (
                            data.map((item, index) => (
                                <TableRow key={item.id} index={index}>
                                    ...
                                    <TableCell className="text-primary text-start">{item?.description ?? "-"}</TableCell>
                                    {/*  */}
                                                ...
                                                <DropdownMenuContent className="w-fit mr-8 mt-1 bg-white">
                                                    ...
                                                    <DropdownMenuGroup>
                                                        <DropdownMenuItem onSelect={(e) => e.preventDefault()}>
                                                            <Link className="w-full" href={`/data-master/why-us/edit/${item?.id}`}>

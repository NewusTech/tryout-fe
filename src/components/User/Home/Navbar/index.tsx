...
const Navbar = () => {
    ...
    return (
        <div className="">
            <div
                className={`fixed  hidden md:block w-full z-50 transition-all duration-300 ease-in-out ${scrolled ? 'bg-secondary/10' : ''
                    }`}
            >
            ...
            ${scrolled ? 'text-secondary' : ''}`}
                        ...
                        <div className="wrap ml-4 flex gap-3 items-center">
                            ...
                            <Link href="/login" className="loginn bg-white p-2 px-12 hover:bg-secondary-hover  rounded-full text-primary">
                                Daftar
                            </Link>
